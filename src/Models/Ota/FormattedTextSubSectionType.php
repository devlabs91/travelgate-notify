...
class FormattedTextSubSectionType
{
     ...
     *
     * @property \Devlabs91\TravelgateNotify\Models\Ota\ParagraphType[] $paragraph
     */
    private $paragraph = [
     ...
     *
     * @return self
     * @param \Devlabs91\TravelgateNotify\Models\Ota\ParagraphType $paragraph
     */
    public function addToParagraph(\Devlabs91\TravelgateNotify\Models\Ota\ParagraphType $paragraph)
    {
