...
namespace Devlabs91\TravelgateNotify\Models\Ota\VehicleAvailRQCoreType\VendorPrefsAType;
...
class VendorPrefAType extends CompanyNamePrefType
{
    ...
    /**
     * This is the vendor specific code used to identify a special rate associated with a specific organization. Used when multiple vendors have been requested and there is a different code for each.
     *
