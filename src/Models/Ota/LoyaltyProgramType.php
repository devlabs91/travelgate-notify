...
class LoyaltyProgramType
{
    ...
    /**
     * When true, indicates this is the primary loyalty program and when false, indicates this is not the primary loyalty program.
     *
     * @property bool $primaryLoyaltyIndicator
     */
