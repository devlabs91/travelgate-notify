...
class VehicleWhereAtFacilityType
{
    ...
    /**
     * The Location attribute identifies the location of an item at an airport. Refer to OpenTravel Code List Vehicle Where At Facility (VWF) (e.g., shuttle on airport).
     *
