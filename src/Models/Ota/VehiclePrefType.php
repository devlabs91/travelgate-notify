...
class VehiclePrefType extends VehicleCoreType
{
     ...
     *
     * @property \Devlabs91\TravelgateNotify\Models\Ota\VehiclePrefType\VehMakeModelAType $vehMakeModel
     */
     ...
     * The make and model of the vehicle (e.g., Ford Focus). The Code attribute may be used for the SIPP code.
     *
     * @return \Devlabs91\TravelgateNotify\Models\Ota\VehiclePrefType\VehMakeModelAType
     */
     ...
     * The make and model of the vehicle (e.g., Ford Focus). The Code attribute may be used for the SIPP code.
     *
     * @param \Devlabs91\TravelgateNotify\Models\Ota\VehiclePrefType\VehMakeModelAType $vehMakeModel
     * @return self
     */
    public function setVehMakeModel(\Devlabs91\TravelgateNotify\Models\Ota\VehiclePrefType\VehMakeModelAType $vehMakeModel)
    {
