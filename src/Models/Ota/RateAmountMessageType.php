...
class RateAmountMessageType
{
     ...
     *
     * @property \Devlabs91\TravelgateNotify\Models\Ota\RateAmountMessageType\RatesAType\RateAType[] $rates
     */
    private $rates = null;
     ...
     */
    public function addToRates(\Devlabs91\TravelgateNotify\Models\Ota\RateAmountMessageType\RatesAType\RateAType $rate)
    {
        $this->rates[] = $rate;
        return $this;
    }
     ...
     * A collection of rate changes to be synchronized between systems.
     *
     * @param \Devlabs91\TravelgateNotify\Models\Ota\RateAmountMessageType\RatesAType\RateAType[] $rates
     * @return self
     */
