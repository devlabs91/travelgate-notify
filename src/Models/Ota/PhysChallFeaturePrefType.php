...
class PhysChallFeaturePrefType
{
    ...
    /**
     * Identifies the types of features the hotel offers to service physically challenged guests. Refer to OpenTravel Code List Physically Challenged Feature Code (PHY).
     *
