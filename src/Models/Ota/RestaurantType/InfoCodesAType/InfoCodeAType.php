...
namespace Devlabs91\TravelgateNotify\Models\Ota\RestaurantType\InfoCodesAType;
...
class InfoCodeAType
{
    ...
    /**
     * This name refers to an OpenTravel Code List table (e.g. RestaurantCategoryCode/InfoCode). The actual code is passed in the Code attribute.
     *
