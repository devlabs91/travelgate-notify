...
class GuestsAType
{
     ...
     *
     * @property \Devlabs91\TravelgateNotify\Models\Ota\HotelRoomListType\GuestsAType\GuestAType[] $guest
     */
    private $guest = [
     ...
     */
    public function addToGuest(\Devlabs91\TravelgateNotify\Models\Ota\HotelRoomListType\GuestsAType\GuestAType $guest)
    {
        $this->guest[] = $guest;
        return $this;
    }
