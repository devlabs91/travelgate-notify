...
class TicketAType
{
    ...
    /**
     * Indicates if the check digit of the ticket number or the interline agreement has to be checked or not.
     *
    ...
    /**
     * Gives a list of references to coupon numbers of the ticket which will be taken for payment.
     *
     ...
     *
     * @property \Devlabs91\TravelgateNotify\Models\Ota\PaymentFormType\TicketAType\ConjunctionTicketNbrAType[] $conjunctionTicketNbr
     */
    private $conjunctionTicketNbr = [
     ...
     *
     * @return self
     * @param \Devlabs91\TravelgateNotify\Models\Ota\PaymentFormType\TicketAType\ConjunctionTicketNbrAType $conjunctionTicketNbr
     */
    public function addToConjunctionTicketNbr(\Devlabs91\TravelgateNotify\Models\Ota\PaymentFormType\TicketAType\ConjunctionTicketNbrAType $conjunctionTicketNbr)
    {
     ...
     * Conjunction ticket number in case a conjunction ticket is exchanged.
     *
     * @return \Devlabs91\TravelgateNotify\Models\Ota\PaymentFormType\TicketAType\ConjunctionTicketNbrAType[]
     */
