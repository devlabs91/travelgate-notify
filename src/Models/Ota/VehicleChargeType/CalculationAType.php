...
class CalculationAType
{
    ...
    /**
     * Indicates a time or a place of reference (e.g. before pick-up, drop-off location).
     *
    ...
    /**
     * The total for a specific item in a calculation (e.g., ten day rental = one week plus three extra days; this attribute would provide the subtotal for just the three extra days. The VehChargeType can be used to show the total for the ten day rental).
     *
