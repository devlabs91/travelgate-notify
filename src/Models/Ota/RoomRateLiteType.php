...
class RoomRateLiteType
{
    ...
    /**
     * @property \Devlabs91\TravelgateNotify\Models\Ota\AmountLiteType[] $rates
     */
    private $rates = null;
     ...
     *
     * @return self
     * @param \Devlabs91\TravelgateNotify\Models\Ota\AmountLiteType $rate
     */
    public function addToRates(\Devlabs91\TravelgateNotify\Models\Ota\AmountLiteType $rate)
    {
        $this->rates[] = $rate;
        return $this;
    }
     ...
     * Gets as rates
     *
     * @return \Devlabs91\TravelgateNotify\Models\Ota\AmountLiteType[]
     */
     ...
     * Sets a new rates
     *
     * @param \Devlabs91\TravelgateNotify\Models\Ota\AmountLiteType[] $rates
     * @return self
     */
