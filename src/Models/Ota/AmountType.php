...
class AmountType
{
     ...
     *
     * @property bool $alternateCurrencyInd
     */
     ...
     *
     * @property \Devlabs91\TravelgateNotify\Models\Ota\TotalType $base
     */
    private $base = null;
     ...
     *
     * @property \Devlabs91\TravelgateNotify\Models\Ota\AmountType\AdditionalGuestAmountsAType $additionalGuestAmounts
     */
     ...
     *
     * @property \Devlabs91\TravelgateNotify\Models\Ota\AmountType\DiscountAType[] $discount
     */
    private $discount = [
     ...
     * The base amount charged for the accommodation or service per unit of time (ex: Nightly, Weekly, etc). If TaxInclusive is set to True, then taxes are included in the base amount. Note that any additional charges should itemized in the other elements.
     *
     * @param \Devlabs91\TravelgateNotify\Models\Ota\TotalType $base
     * @return self
     */
    public function setBase(\Devlabs91\TravelgateNotify\Models\Ota\TotalType $base)
    {
        $this->base = $base;
        return $this;
    }
     ...
     * A collection of charges that apply to for additional occupants, guests or service users (over and above the rate's MaxGuest Applicable).
     *
     * @return \Devlabs91\TravelgateNotify\Models\Ota\AmountType\AdditionalGuestAmountsAType
     */
     ...
     * A collection of charges that apply to for additional occupants, guests or service users (over and above the rate's MaxGuest Applicable).
     *
     * @param \Devlabs91\TravelgateNotify\Models\Ota\AmountType\AdditionalGuestAmountsAType $additionalGuestAmounts
     * @return self
     */
    public function setAdditionalGuestAmounts(\Devlabs91\TravelgateNotify\Models\Ota\AmountType\AdditionalGuestAmountsAType $additionalGuestAmounts)
    {
     ...
     *
     * @return self
     * @param \Devlabs91\TravelgateNotify\Models\Ota\AmountType\DiscountAType $discount
     */
    public function addToDiscount(\Devlabs91\TravelgateNotify\Models\Ota\AmountType\DiscountAType $discount)
    {
     ...
     * Discount percentage and/or Amount, code and textual reason for discount
     *
     * @return \Devlabs91\TravelgateNotify\Models\Ota\AmountType\DiscountAType[]
     */
