...
class RoomTypesAType
{
    ...
    /**
     * @property \Devlabs91\TravelgateNotify\Models\Ota\RoomTypeType[] $roomType
     */
    private $roomType = [
     ...
     */
    public function addToRoomType(\Devlabs91\TravelgateNotify\Models\Ota\RoomTypeType $roomType)
    {
