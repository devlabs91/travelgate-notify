...
use Devlabs91\TravelgateNotify\Models\Ota\VehicleRentalCoreType;
...
class PickUpReturnDetailsAType extends VehicleRentalCoreType
{
    ...
    /**
     * Used to identify the context of the element and whether the content applies to expected data verses actual data. Actual data will not be known until the time of CheckIn.
     *
